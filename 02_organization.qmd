...
The disclosure policy can be viewed [here](assets/CPP_Disclosure_Policy_2022-09-23.pdf).

## Practice Parameter Nomination and Prioritization

The process of deciding practice parameters to update or develop is outlined in @fig-prioritization. Existing practice parameters are prioritized annually for updating by ASA leadership, the Anesthesia Patient Safety Foundation (APSF), committee chairs, and CPP members. Topic nominations are solicited from ASA leadership, committee chairs, and APSF in a standardized format. Nominations for new practice parameters are also accepted from others at any time (sent to the CPP chair or submitted to [ASA Standards and Guidelines](mailto:Guidelines@asahq.org); see [template](assets/Nomination_Template_2023-07-24.pdf) for suggested content).
...
![Depiction of the prioritization process.](assets/prioritization.png){#fig-prioritization width="100%"}
...
![Depiction of the practice parameter development process.](assets/process.png){#fig-process width="40%"}
